...
Matrix* Linear::InverseGauss(Matrix* m) {
	...
	for (size_t i = 0; i < A->rows; i++) {
		...
		//TODO: перенести этот цикл в верхний, хт€ бы частичн итерации будут выполн€тьс€
		//на больших матрицах может получитьс€ экономи€
		//хот€ это надо дл€ E
...
Vector* Linear::multiply(Matrix* a, Vector* vec) {
	...
	//TODO: функцию создани€ вектора или каста из одномерной матрицы с проверкой ошибок
